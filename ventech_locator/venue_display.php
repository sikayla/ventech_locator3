...
<body class="bg-gray-100 text-gray-800">
    ...
    <nav class="bg-white shadow-sm p-4 sticky top-0 z-20"> <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <?php else: ?>
                    <a href="/ventech_locator/client_login.php" class="text-gray-700 hover:text-yellow-600 mr-4 font-medium">Login</a>
                    <a href="/ventech_locator/client_register.php" class="text-gray-700 hover:text-yellow-600 font-medium">Register</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
                        ...
                        <?php if ($isVenueOpen): ?>
                            ...
                            <?php else: ?>
                                <p class="text-center text-red-600 bg-red-50 p-3 rounded border border-red-200 text-sm">
                                    Please <a href="/ventech_locator/client_login.php?redirect=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>" class="font-bold underline hover:text-red-800">Login</a> or
                                    <a href="/ventech_locator/client_register.php" class="font-bold underline hover:text-red-800">Register</a> to make a reservation.
                                </p>
                            <?php endif; ?>
